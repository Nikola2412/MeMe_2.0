...
import com.example.meme.placeholder.PlaceholderContent.PlaceholderItem;
...
public class videoRecyclerViewAdapter extends RecyclerView.Adapter<videoRecyclerViewAdapter.ViewHolder> {
    ...
    public videoRecyclerViewAdapter(List<PlaceholderItem> items) {
        mValues = items;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(VideoItemBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
